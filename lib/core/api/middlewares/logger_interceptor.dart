...
// import 'package:carrykind/core/database/shared_pref_helper.dart';
...
// TODO: check token here
    _log(
        key: 'Extra: ',
        value:
            ' ${options.extra.entries.isNotEmpty && options.extra.entries.elementAt(0).value == false ? 'Token is not Required' : 'Token: '}',
        style: style);
